...
from resource.refeicoes import Refeicoes, RefeicoesId
...
api.add_resource(Refeicoes, '/refeicoes')
api.add_resource(RefeicoesId, '/refeicoes/<int:id>')
api.add_resource(RefeicoesPreparacao, '/refeicao_preparacao')
api.add_resource(RefeicoesPreparacaoId, '/refeicao_preparacao/<int:id>')

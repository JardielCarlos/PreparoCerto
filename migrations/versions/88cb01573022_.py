...
Revision ID: 88cb01573022
Revises: 
Create Date: 2023-06-30 16:04:59.754884
...
def upgrade():
    ...
    op.create_table('tb_imgpreparacao',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('empresa_id', sa.Integer(), nullable=True),
    sa.Column('fotoPerfil_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['empresa_id'], ['tb_empresa.id'], ),
    sa.ForeignKeyConstraint(['fotoPerfil_id'], ['tb_imgpreparacao.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('tb_imgpreparacao')

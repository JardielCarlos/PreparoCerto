...
Revision ID: 8aba8a71243d
Revises: 
Create Date: 2023-06-02 11:54:49.838920
...
def upgrade():
    ...
    op.create_table('tb_preparacaorefeicao',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('refeicao_id', sa.Integer(), nullable=True),
    sa.Column('preparacao_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['preparacao_id'], ['tb_preparacao.id'], ),
    sa.ForeignKeyConstraint(['refeicao_id'], ['tb_refeicao.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('tb_preparacaorefeicao')
